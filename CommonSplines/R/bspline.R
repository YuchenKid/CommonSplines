...
#'
#' This function provides nonparametric regressions using B-splines. The B-splines are generated by the function \code{bs_basis}.
#' The return value of \code{bs_basis} is required as an argument of \code{bs_predict}
#'
#' @param x_test The input values at which evaluations are required.
#' @param basis The return value of function \code{bs_basis}.
...
#' @export
bs_predict<-function (x_test,basis)
{
  basis<-bs_basis(x,y,order,innerknots)
  knots <-basis$knots
  order<-basis$order
